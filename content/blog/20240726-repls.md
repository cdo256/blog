...
- Lacework) Abstract hardware catches concrete bugs
...
- TOASTER - A Toolchain for Generating Erlang Stubs with Inline Runtime Monitors from Timeout Asynchronous Session
- Types - Jonah Pears (University of Kent)
...
## Algebraic effects with parameters and their handlers
by *[Jesse Sigal](https://www.jsigal.com/) (University of Edinburgh)*
joint work with:
- *[Ohad Kammar](https://www.inf.ed.ac.uk/people/staff/Ohad_Kammar.html) (University of Edinburgh)*,
- *[Cristina Matache](https://homepages.inf.ed.ac.uk/cmatache/) (University of Edinburgh)*, and
- *[Conor McBride](https://www.strath.ac.uk/staff/mcbrideconordr/) (University of Strathclyde)*
...
**Definitions:**
- **[Algebraic Effects](https://overreacted.io/algebraic-effects-for-the-rest-of-us/):** A way to represent operations that can have different
  effects depending on their context.
- **[Kripke Semantics](https://en.wikipedia.org/wiki/Kripke_semantics):** A framework for modeling possible worlds and their
  interactions.
- **[Dependent Types](https://en.wikipedia.org/wiki/Dependent_type):** A logic where types can depend on values.
...
- **[Complete Lattice](https://ncatlab.org/nlab/show/complete+lattice):** A structure where every subset has both a least upper
  bound and a greatest lower bound.
- **[Monotone map](https://en.wikipedia.org/wiki/Monotonic_function):** A function that preserves the order of elements.
- **[Denotational
...
**Definitions:**
- **[Knightian uncertainty](https://en.wikipedia.org/wiki/Knightian_uncertainty):** A lack of any quantifiable knowledge about some
...
- **[Graded Monads](https://arxiv.org/pdf/2307.16558):** Structures that manage different levels of computation or
  effects.
...
**Definitions:**
- **Binary Analysis Framework:** Tools for analyzing compiled programs.
- **Isabelle/HOL:** A proof assistant for higher-order logic.
- **Hoare Logic:** A formal system for reasoning about the correctness of
  imperative programs.
- **BAP (Binary Analysis Platform):** A framework for analyzing binary code.
...
**Definitions:**
- **Virtual Memory Synchronization:** Coordination of memory access in a virtual
  memory system.
...
**Definitions:**
- **Shared Memory Concurrency:** Multiple threads accessing shared memory
  simultaneously.
- **Atomic Operations:** Operations that are completed in a single step without
  interference.
...
- **Rely/Guarantee Conditions:** Specifications that describe the behavior of
...
**Definitions:**
- **ABI (Application Binary Interface):** A set of rules for binary
  compatibility between programs.
- **Concurrent Programs:** Programs that run multiple computations
  simultaneously.
- **Compiler Bugs:** Errors in the software that translates code from one
  language to another.
...
- **Oracle-Guided Scheduling:** Using a predictor to guide task scheduling in
  parallel computing.
...
**Definitions:**
- **Asynchronous Subtyping:** A type system that allows reordering of actions in
...
- **Graded Modal Types:** Types that describe how computations affect their
  context.
...
**Definitions:**
- **Asynchronous Session Types:** Type systems ensuring safe communication in
  asynchronous protocols.
- **Timeouts:** Mechanisms that prevent indefinite waiting for an event.
